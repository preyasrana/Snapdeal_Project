...
@CucumberOptions(features = "src/test/resources/Features/PlaceOrder.feature", glue = { "" }, monochrome = true, plugin = {
		...
		"timeline:test-output-thread/" }, tags = "@Regression or @Smoke")
